...
data_dir_bc_filtered <- "/gpfs/helios/home/rostamne/CVS_SplVacc_BM__Ghr_Thy_Jul_24_scRNA/code/GT3/GEX_GT3_multi/outs/per_sample_outs/GEX_GT3_multi/count/sample_filtered_feature_bc_matrix/"
...
seurat_obj <- CreateSeuratObject(counts = rna_counts, project = 'GT3')
